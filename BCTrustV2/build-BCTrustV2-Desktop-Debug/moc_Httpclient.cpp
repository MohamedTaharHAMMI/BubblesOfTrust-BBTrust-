...
#include "../BCTrustV2/Httpclient.h"
...
const QMetaObject HttpClient::staticMetaObject = {
    { &QJsonRpcHttpClient::staticMetaObject, qt_meta_stringdata_HttpClient.data,
...
void *HttpClient::qt_metacast(const char *_clname)
{
    ...
    return QJsonRpcHttpClient::qt_metacast(_clname);
}

int HttpClient::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QJsonRpcHttpClient::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
